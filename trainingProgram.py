...
#
#
#reads in training data to train NN. training data consists of precategorized images grouped into category folders
#
#
...
early_stopping = 20  # use None if you don't want to implement early stoping



train_path='Data\TrainingImages'
...
def optimize(num_iterations):
    ...
    for i in range(total_iterations,
        ...
        saver.save(session, 'C:\\Users\\Brian\\Desktop\\NeuralNet\\my_test_model')
